...
<div class="container">
    <h3 class="text-center mb-4">Approved Leave Requests</h3>
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td><span style="color: lightgreen; font-weight:bold;"><?= $row['Status'] ?></span></td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <form method="POST" action="approved_requests.php" class="px-3 py-1">
